...
var author$project$Main$init = {count: 0, text: ''};
...
var author$project$Main$asNumber = function (value) {
	return A2(
		...
		switch (msg.$) {
			case 'Increment':
				return _Utils_update(
					...
					{
						count: model.count + 1,
						text: elm$core$String$fromInt(model.count)
					});
			case 'Decrement':
				return _Utils_update(
					model,
			...
			default:
				...
				return _Utils_update(
					model,
					{
						count: author$project$Main$asNumber(model.text),
						text: value
					});
		}
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('boxCounter')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(
						'Current value is: ' + elm$core$String$fromInt(model.count))
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Increment counter')
							])),
						A2(
						elm$html$Html$div,
						_List_Nil,
						...
						_List_fromArray(
							[
								elm$html$Html$text('Decrement counter')
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Reset counter')
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$placeholder('Input your own'),
